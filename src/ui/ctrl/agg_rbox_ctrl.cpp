...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    RBoxCtrlBase::RBoxCtrlBase(double x1, double y1, 
    ...
    //------------------------------------------------------------------------
    bool RBoxCtrlBase::on_mouse_button_down(double x, double y)
    {
        inverse_transform_xy(&x, &y);
        unsigned i;
    ...
    //------------------------------------------------------------------------
    bool RBoxCtrlBase::on_mouse_move(double, double, bool)
    {
        return false;
    }

    //------------------------------------------------------------------------
    bool RBoxCtrlBase::on_mouse_button_up(double, double)
    {
        return false;
    }
